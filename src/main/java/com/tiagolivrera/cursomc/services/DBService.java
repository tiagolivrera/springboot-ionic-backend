...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "thyago.olfre@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "ana.costa@gmail.com", "72021082083", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano Peixoto", "2106", "Ap. 202", "Jardim Sao Paulo", "58277012",
				cli2, c2);
